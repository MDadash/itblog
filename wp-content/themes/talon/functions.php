...
function talon_scripts() {
	...
	wp_enqueue_script( 'jquery-mask', get_template_directory_uri() . '/js/main.js', array('jquery'), '', true );
	
	wp_enqueue_script( 'talon-main', get_template_directory_uri() . '/js/jquery.mask.js', array(), '', true );
